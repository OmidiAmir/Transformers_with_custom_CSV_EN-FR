...
en_path_train = "data/en-fr/opus.en-fr-train.en"
fr_path_train = "data/en-fr/opus.en-fr-train.fr"

en_path_test = "data/en-fr/opus.en-fr-test.en"
fr_path_test = "data/en-fr/opus.en-fr-test.fr"

en_path_val = "data/en-fr/opus.en-fr-dev.en"
fr_path_val = "data/en-fr/opus.en-fr-dev.fr"
...
df_train.to_csv("data/opus100_en_fr_train.csv", index=False)
print("Saved to data/en-fr/opus100_en_fr_train.csv")

df_test.to_csv("data/opus100_en_fr_test.csv", index=False)
print("Saved to data/en-fr/opus100_en_fr_test.csv")

df_val.to_csv("data/opus100_en_fr_val.csv", index=False)
